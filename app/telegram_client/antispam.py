...
# Общий темп аккаунта: реже этой паузы не шлёт никто из bulk-отправителей
# (рассылка, постер, веер). У каждого свой круг и своя пауза, но круги идут
# одновременно — без общего темпа три рассылки на одном номере дают три
# сообщения в секунду. Пересылка через очередь отмечает свои отправки в том
# же журнале, и bulk-отправители уступают ей тоже.
# Суммарно по всем задачам аккаунта: чаще — темп спам-бота, а не человека.
ACCOUNT_SEND_GAP = 20.0
